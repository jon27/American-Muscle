...
var EdmundsForm = React.createClass({
          ...
          success: function(data){
            ...
            var cars = data;
              if(data){
                ...
                var cy = data.styles[0].engine.cylinder;
 ...
 var renderMessage = () => {
  if(cy !== ""){
    ...
    return <h3>Your information will display here!</h3>
  }
 }

    return (
      <div>
        <h1 className="text-center page-title">Search specs of any vehicle</h1>
        <form ref="EdmundsForm" className="border" onSubmit={this.onFormSubmit}>
          <span className="edmundsForm">
          ...
          <button className="button-black expanded hollow button-padding">Submit</button>
          </span>
        </form>
        <div>
...
module.exports = EdmundsForm;
    ...
    // return <h3 className="text-center page-title"><span id="cylinder"></span><span id="horsepower"></span><span id="torque"></span><span id="gasType"></span></h3>
